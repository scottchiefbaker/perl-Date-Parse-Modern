...
ok(strtotime('2002-07-22 10:00:00 Z') == 1027332000, 'ISO 8601 HH:MM Z');
...
ok(strtotime('Thu, 13 Oct 94 10:13:13 +0700')         == 782017993 , 'Numeric timezone offset four digits');
ok(strtotime('Thu, 09 Sep 96 11:12:13 -500')          == 842285533 , 'Numeric timezone offset three digits');

# Check the extremes
ok(strtotime('2800-06-06') == 26205836400, 'Way in the future');
ok(strtotime('1800-06-06') == -5351155622, 'Way in the past');
